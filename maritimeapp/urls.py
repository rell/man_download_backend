...
from .views import (
    ...
    SiteMeasurementsDaily15ListDate
...
urlpatterns = [
    ...
    path('sites/measurements/', SiteMeasurementsDaily15ListDate.as_view(), name='measurement-list'),
    path('sites/measurements/<str:startdate>/', SiteMeasurementsDaily15ListDate.as_view(), name='measurement-list'),
    path('sites/measurements/<str:startdate>/<str:enddate>/', SiteMeasurementsDaily15ListDate.as_view(),
         name='measurement-list'),
    path('sites/<str:name>/measurements/daily20/', SiteMeasurementsDaily20List.as_view(),
         name='site-measurements-daily20'),
    path('sites/measurements/', SiteMeasurementsDaily20ListDate.as_view(), name='measurement-list'),
    path('sites/measurements/<str:startdate>/', SiteMeasurementsDaily20ListDate.as_view(), name='measurement-list'),
    path('sites/measurements/<str:startdate>/<str:enddate>/', SiteMeasurementsDaily20ListDate.as_view(),
         name='measurement-list'),
    # path('sites/<str:name>/measurements/AP10/', SiteMeasurementsAllPoints10List.as_view(),
